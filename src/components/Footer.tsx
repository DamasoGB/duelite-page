...
return(
    <footer>
        ...
        <a href="https://twitter.com/betakingstudios" className='footerlink' aria-label='See what BetakingStudios have posted on Twitter'><img src={Twitter} className='footerimg' alt='Twitter'/></a>
